...
type DnsV1HostedZonesApiAPICreateHostedZoneRequest struct {
	...
	hostedZoneCreateRequestV1Dot2 *HostedZoneCreateRequestV1Dot2
}

func (r DnsV1HostedZonesApiAPICreateHostedZoneRequest) HostedZoneCreateRequestV1Dot2(hostedZoneCreateRequestV1Dot2 HostedZoneCreateRequestV1Dot2) DnsV1HostedZonesApiAPICreateHostedZoneRequest {
	r.hostedZoneCreateRequestV1Dot2 = &hostedZoneCreateRequestV1Dot2
	return r
}
...
Create a new hosted zone (v1.2 supports private_dns_id; required only when type=private)
...
func (a *DnsV1HostedZonesApiAPIService) CreateHostedZoneExecute(r DnsV1HostedZonesApiAPICreateHostedZoneRequest) (*HostedZoneCreateResponse, *http.Response, error) {
	...
	if r.hostedZoneCreateRequestV1Dot2 == nil {
		return localVarReturnValue, nil, reportError("hostedZoneCreateRequestV1Dot2 is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.hostedZoneCreateRequestV1Dot2
	if r.ctx != nil {
...
func (r DnsV1HostedZonesApiAPIListHostedZoneRequest) Execute() (*HostedZoneListResponseV1Dot2, *http.Response, error) {
...
Return list of hosted zones (v1.2 adds private_dns_name and pool_id filtering)
...
// Execute executes the request
//
//	@return HostedZoneListResponseV1Dot2
func (a *DnsV1HostedZonesApiAPIService) ListHostedZoneExecute(r DnsV1HostedZonesApiAPIListHostedZoneRequest) (*HostedZoneListResponseV1Dot2, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *HostedZoneListResponseV1Dot2
	)
...
func (r DnsV1HostedZonesApiAPIShowHostedZoneRequest) Execute() (*HostedZoneShowResponseV1Dot2, *http.Response, error) {
...
Return details of a hosted zone (v1.2 adds private_dns_name)
...
func (a *DnsV1HostedZonesApiAPIService) ShowHostedZoneExecute(r DnsV1HostedZonesApiAPIShowHostedZoneRequest) (*HostedZoneShowResponseV1Dot2, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *HostedZoneShowResponseV1Dot2
	)
