...
// checks if the HostedZoneDeleteResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostedZoneDeleteResponse{}

// HostedZoneDeleteResponse struct for HostedZoneDeleteResponse
type HostedZoneDeleteResponse struct {
...
type _HostedZoneDeleteResponse HostedZoneDeleteResponse
...
func (o *HostedZoneDeleteResponse) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *HostedZoneDeleteResponse) SetDescriptionNil() {
...
func (o *HostedZoneDeleteResponse) SetHostedZoneTypeNil() {
...
func (o *HostedZoneDeleteResponse) SetSharedNil() {
	o.Shared.Set(nil)
}
...
func (o *HostedZoneDeleteResponse) SetTransferredAtNil() {
...
func (o *HostedZoneDeleteResponse) SetTtlNil() {
	o.Ttl.Set(nil)
}
...
func (o *HostedZoneDeleteResponse) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o *HostedZoneDeleteResponse) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o *HostedZoneDeleteResponse) SetVersionNil() {
	o.Version.Set(nil)
}
...
func (o HostedZoneDeleteResponse) MarshalJSON() ([]byte, error) {
...
func (o HostedZoneDeleteResponse) ToMap() (map[string]interface{}, error) {
...
func (o *HostedZoneDeleteResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varHostedZoneDeleteResponse := _HostedZoneDeleteResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHostedZoneDeleteResponse)

	if err != nil {
		return err
	}

	*o = HostedZoneDeleteResponse(varHostedZoneDeleteResponse)

	return err
}

type NullableHostedZoneDeleteResponse struct {
	value *HostedZoneDeleteResponse
	isSet bool
}

func (v NullableHostedZoneDeleteResponse) Get() *HostedZoneDeleteResponse {
	return v.value
}

func (v *NullableHostedZoneDeleteResponse) Set(val *HostedZoneDeleteResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableHostedZoneDeleteResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableHostedZoneDeleteResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostedZoneDeleteResponse(val *HostedZoneDeleteResponse) *NullableHostedZoneDeleteResponse {
	return &NullableHostedZoneDeleteResponse{value: val, isSet: true}
}

func (v NullableHostedZoneDeleteResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostedZoneDeleteResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
