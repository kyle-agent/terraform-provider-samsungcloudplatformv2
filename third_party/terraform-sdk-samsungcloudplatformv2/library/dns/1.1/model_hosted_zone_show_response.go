...
// checks if the HostedZoneShowResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostedZoneShowResponse{}

// HostedZoneShowResponse struct for HostedZoneShowResponse
type HostedZoneShowResponse struct {
...
type _HostedZoneShowResponse HostedZoneShowResponse
...
func (o *HostedZoneShowResponse) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *HostedZoneShowResponse) SetDescriptionNil() {
...
func (o *HostedZoneShowResponse) SetHostedZoneTypeNil() {
...
func (o *HostedZoneShowResponse) SetName(v string) {
	o.Name = v
}
...
func (o *HostedZoneShowResponse) SetSerial(v int32) {
	o.Serial = v
}
...
func (o *HostedZoneShowResponse) SetSharedNil() {
	o.Shared.Set(nil)
}
...
func (o *HostedZoneShowResponse) SetTransferredAtNil() {
...
func (o *HostedZoneShowResponse) SetTtlNil() {
	o.Ttl.Set(nil)
}
...
func (o *HostedZoneShowResponse) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o *HostedZoneShowResponse) GetUpdatedAt() string {
...
func (o *HostedZoneShowResponse) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o *HostedZoneShowResponse) SetVersionNil() {
	o.Version.Set(nil)
}
...
func (o HostedZoneShowResponse) MarshalJSON() ([]byte, error) {
...
func (o HostedZoneShowResponse) ToMap() (map[string]interface{}, error) {
...
func (o *HostedZoneShowResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varHostedZoneShowResponse := _HostedZoneShowResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHostedZoneShowResponse)

	if err != nil {
		return err
	}

	*o = HostedZoneShowResponse(varHostedZoneShowResponse)

	return err
}

type NullableHostedZoneShowResponse struct {
	value *HostedZoneShowResponse
	isSet bool
}

func (v NullableHostedZoneShowResponse) Get() *HostedZoneShowResponse {
	return v.value
}

func (v *NullableHostedZoneShowResponse) Set(val *HostedZoneShowResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableHostedZoneShowResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableHostedZoneShowResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostedZoneShowResponse(val *HostedZoneShowResponse) *NullableHostedZoneShowResponse {
	return &NullableHostedZoneShowResponse{value: val, isSet: true}
}

func (v NullableHostedZoneShowResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostedZoneShowResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
