...
// checks if the PostgresqlClusterDetailResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlClusterDetailResponse{}

// PostgresqlClusterDetailResponse struct for PostgresqlClusterDetailResponse
...
type _PostgresqlClusterDetailResponse PostgresqlClusterDetailResponse
...
func NewPostgresqlClusterDetailResponse(accountId string, createdAt time.Time, createdBy string, dbaasEngine string, dbaasEngineVersionName string, id string, initConfigOption PostgresqlInitConfigOptionDetail, instanceGroups []InstanceGroupResponse, modifiedAt time.Time, modifiedBy string, name string, productImageType string, productType ProductType, replicas []string, roleType NullableClusterRoleType, serviceState ServiceState, softwareVersion string, subnetId string, timezone string) *PostgresqlClusterDetailResponse {
	this := PostgresqlClusterDetailResponse{}
...
func (o *PostgresqlClusterDetailResponse) SetMaintenanceOptionNil() {
...
func (o *PostgresqlClusterDetailResponse) SetOriginClusterIdNil() {
...
func (o *PostgresqlClusterDetailResponse) SetVipPublicIpAddressNil() {
...
func (o *PostgresqlClusterDetailResponse) SetVipPublicIpIdNil() {
...
func (o *PostgresqlClusterDetailResponse) SetVirtualIpAddressNil() {
...
func (o PostgresqlClusterDetailResponse) MarshalJSON() ([]byte, error) {
...
func (o PostgresqlClusterDetailResponse) ToMap() (map[string]interface{}, error) {
...
func (o *PostgresqlClusterDetailResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPostgresqlClusterDetailResponse := _PostgresqlClusterDetailResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostgresqlClusterDetailResponse)

	if err != nil {
		return err
	}

	*o = PostgresqlClusterDetailResponse(varPostgresqlClusterDetailResponse)

	return err
}

type NullablePostgresqlClusterDetailResponse struct {
	value *PostgresqlClusterDetailResponse
	isSet bool
}

func (v NullablePostgresqlClusterDetailResponse) Get() *PostgresqlClusterDetailResponse {
	return v.value
}

func (v *NullablePostgresqlClusterDetailResponse) Set(val *PostgresqlClusterDetailResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePostgresqlClusterDetailResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePostgresqlClusterDetailResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostgresqlClusterDetailResponse(val *PostgresqlClusterDetailResponse) *NullablePostgresqlClusterDetailResponse {
	return &NullablePostgresqlClusterDetailResponse{value: val, isSet: true}
}

func (v NullablePostgresqlClusterDetailResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostgresqlClusterDetailResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
