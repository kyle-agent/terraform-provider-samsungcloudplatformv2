...
func (r BaremetalBlockstorageV1VolumeGroupReplicationV1APIsAPIShowVolumeGroupReplicationRequest) Execute() (*VolumeGroupReplicationSyncResponseV1Dot3, *http.Response, error) {
...
// Execute executes the request
//  @return VolumeGroupReplicationSyncResponseV1Dot3
func (a *BaremetalBlockstorageV1VolumeGroupReplicationV1APIsAPIService) ShowVolumeGroupReplicationExecute(r BaremetalBlockstorageV1VolumeGroupReplicationV1APIsAPIShowVolumeGroupReplicationRequest) (*VolumeGroupReplicationSyncResponseV1Dot3, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *VolumeGroupReplicationSyncResponseV1Dot3
	)
