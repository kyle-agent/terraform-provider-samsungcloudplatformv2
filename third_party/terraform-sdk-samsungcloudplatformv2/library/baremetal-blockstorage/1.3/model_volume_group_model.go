...
type VolumeGroupModel struct {
	...
	MemberVolumes []MemberVolumeWithRecoveryInfo `json:"member_volumes,omitempty"`
	// Modified at
	...
	Recovery *RecoveryVolumeGroupInfo `json:"recovery,omitempty"`
	// Snapshot schedule
...
func (o *VolumeGroupModel) GetMemberVolumes() []MemberVolumeWithRecoveryInfo {
	if o == nil || IsNil(o.MemberVolumes) {
		var ret []MemberVolumeWithRecoveryInfo
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *VolumeGroupModel) GetMemberVolumesOk() ([]MemberVolumeWithRecoveryInfo, bool) {
	if o == nil || IsNil(o.MemberVolumes) {
		return nil, false
	}
...
// SetMemberVolumes gets a reference to the given []MemberVolumeWithRecoveryInfo and assigns it to the MemberVolumes field.
func (o *VolumeGroupModel) SetMemberVolumes(v []MemberVolumeWithRecoveryInfo) {
	o.MemberVolumes = v
}
...
func (o *VolumeGroupModel) GetRecovery() RecoveryVolumeGroupInfo {
	if o == nil || IsNil(o.Recovery) {
		var ret RecoveryVolumeGroupInfo
		return ret
	}
	return *o.Recovery
}
...
// and a boolean to check if the value has been set.
func (o *VolumeGroupModel) GetRecoveryOk() (*RecoveryVolumeGroupInfo, bool) {
	if o == nil || IsNil(o.Recovery) {
		return nil, false
	}
...
func (o *VolumeGroupModel) HasRecovery() bool {
	if o != nil && !IsNil(o.Recovery) {
		return true
	}
...
// SetRecovery gets a reference to the given RecoveryVolumeGroupInfo and assigns it to the Recovery field.
func (o *VolumeGroupModel) SetRecovery(v RecoveryVolumeGroupInfo) {
	o.Recovery = &v
}
