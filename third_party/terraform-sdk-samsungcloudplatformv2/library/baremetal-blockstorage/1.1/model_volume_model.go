...
func (o *VolumeModel) GetRecovery() RecoveryInfo {
...
// and a boolean to check if the value has been set.
func (o *VolumeModel) GetRecoveryOk() (*RecoveryInfo, bool) {
	if o == nil || IsNil(o.Recovery) {
		return nil, false
	}
...
func (o *VolumeModel) HasRecovery() bool {
	if o != nil && !IsNil(o.Recovery) {
		return true
	}
...
func (o *VolumeModel) SetRecovery(v RecoveryInfo) {
	o.Recovery = &v
}
