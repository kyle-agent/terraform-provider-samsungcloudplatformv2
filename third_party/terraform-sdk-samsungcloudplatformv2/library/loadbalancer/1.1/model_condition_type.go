...
const (
	CONDITIONTYPE_URL_PATH      ConditionType = "URL_PATH"
	CONDITIONTYPE_HOST_HEADER   ConditionType = "HOST_HEADER"
	CONDITIONTYPE_PROTOCOL_PORT ConditionType = "PROTOCOL_PORT"
)
