...
func NewListenerForCreate(loadbalancerId string, name string, protocol string, servicePort int32) *ListenerForCreate {
...
func (o *ListenerForCreate) HasRoutingAction() bool {
