...
func NewLbHealthCheckShow(accountId NullableString, createdAt time.Time, createdBy string, healthCheckPort int32, healthCheckType LbMonitorType, healthCheckUrl NullableString, httpMethod NullableString, id string, modifiedAt time.Time, modifiedBy string, name string, requestData NullableString, responseCode NullableString, state string, subnetId NullableString, vpcId NullableString) *LbHealthCheckShow {
