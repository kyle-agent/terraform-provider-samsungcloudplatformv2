...
type LoadbalancerV1LbListenersApiAPICreateLbListenerRequest struct {
	...
	lbListenerCreateRequestV1Dot2 *LbListenerCreateRequestV1Dot2
}

func (r LoadbalancerV1LbListenersApiAPICreateLbListenerRequest) LbListenerCreateRequestV1Dot2(lbListenerCreateRequestV1Dot2 LbListenerCreateRequestV1Dot2) LoadbalancerV1LbListenersApiAPICreateLbListenerRequest {
	r.lbListenerCreateRequestV1Dot2 = &lbListenerCreateRequestV1Dot2
	return r
}
...
func (a *LoadbalancerV1LbListenersApiAPIService) CreateLbListenerExecute(r LoadbalancerV1LbListenersApiAPICreateLbListenerRequest) (*LbListenerShowResponse, *http.Response, error) {
	...
	if r.lbListenerCreateRequestV1Dot2 == nil {
		return localVarReturnValue, nil, reportError("lbListenerCreateRequestV1Dot2 is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.lbListenerCreateRequestV1Dot2
	if r.ctx != nil {
...
type LoadbalancerV1LbListenersApiAPISetLbListenerRequest struct {
	...
	ApiService                 *LoadbalancerV1LbListenersApiAPIService
	listenerId                 string
	lbListenerSetRequestV1Dot2 *LbListenerSetRequestV1Dot2
}

func (r LoadbalancerV1LbListenersApiAPISetLbListenerRequest) LbListenerSetRequestV1Dot2(lbListenerSetRequestV1Dot2 LbListenerSetRequestV1Dot2) LoadbalancerV1LbListenersApiAPISetLbListenerRequest {
	r.lbListenerSetRequestV1Dot2 = &lbListenerSetRequestV1Dot2
	return r
}
...
func (a *LoadbalancerV1LbListenersApiAPIService) SetLbListenerExecute(r LoadbalancerV1LbListenersApiAPISetLbListenerRequest) (*LbListenerShowResponse, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.lbListenerSetRequestV1Dot2 == nil {
		return localVarReturnValue, nil, reportError("lbListenerSetRequestV1Dot2 is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.lbListenerSetRequestV1Dot2
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["X-Auth-Token"]; ok {
