...
type BackupV1BackupsApiAPICreateBackupRequest struct {
	ctx context.Context
	ApiService *BackupV1BackupsApiAPIService
	backupCreateRequest1Dot1 *BackupCreateRequest1Dot1
}

func (r BackupV1BackupsApiAPICreateBackupRequest) BackupCreateRequest1Dot1(backupCreateRequest1Dot1 BackupCreateRequest1Dot1) BackupV1BackupsApiAPICreateBackupRequest {
	r.backupCreateRequest1Dot1 = &backupCreateRequest1Dot1
	return r
}
...
func (a *BackupV1BackupsApiAPIService) CreateBackupExecute(r BackupV1BackupsApiAPICreateBackupRequest) (*SyncResponse, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.backupCreateRequest1Dot1 == nil {
		return localVarReturnValue, nil, reportError("backupCreateRequest1Dot1 is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.backupCreateRequest1Dot1
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["X-Auth-Token"]; ok {
...
func (r BackupV1BackupsApiAPIShowBackupRequest) Execute() (*BackupDetailResponse1Dot1, *http.Response, error) {
...
// Execute executes the request
//  @return BackupDetailResponse1Dot1
func (a *BackupV1BackupsApiAPIService) ShowBackupExecute(r BackupV1BackupsApiAPIShowBackupRequest) (*BackupDetailResponse1Dot1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *BackupDetailResponse1Dot1
	)
