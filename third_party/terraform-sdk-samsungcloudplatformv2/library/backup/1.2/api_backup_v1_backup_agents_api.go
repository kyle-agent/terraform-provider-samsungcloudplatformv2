...
type BackupV1BackupAgentsApiAPICreateBackupAgentRequest struct {
	ctx context.Context
	ApiService *BackupV1BackupAgentsApiAPIService
	backupAgentCreateRequest1Dot2 *BackupAgentCreateRequest1Dot2
}

func (r BackupV1BackupAgentsApiAPICreateBackupAgentRequest) BackupAgentCreateRequest1Dot2(backupAgentCreateRequest1Dot2 BackupAgentCreateRequest1Dot2) BackupV1BackupAgentsApiAPICreateBackupAgentRequest {
	r.backupAgentCreateRequest1Dot2 = &backupAgentCreateRequest1Dot2
	return r
}
...
func (a *BackupV1BackupAgentsApiAPIService) CreateBackupAgentExecute(r BackupV1BackupAgentsApiAPICreateBackupAgentRequest) (*SyncResponse, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.backupAgentCreateRequest1Dot2 == nil {
		return localVarReturnValue, nil, reportError("backupAgentCreateRequest1Dot2 is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.backupAgentCreateRequest1Dot2
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["X-Auth-Token"]; ok {
...
func (r BackupV1BackupAgentsApiAPIListBackupAgentTargetsRequest) Execute() (*BackupAgentTargetListResponse1Dot2, *http.Response, error) {
...
// Execute executes the request
//  @return BackupAgentTargetListResponse1Dot2
func (a *BackupV1BackupAgentsApiAPIService) ListBackupAgentTargetsExecute(r BackupV1BackupAgentsApiAPIListBackupAgentTargetsRequest) (*BackupAgentTargetListResponse1Dot2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *BackupAgentTargetListResponse1Dot2
	)
...
func (r BackupV1BackupAgentsApiAPIListBackupAgentsRequest) Execute() (*BackupAgentListResponse1Dot2, *http.Response, error) {
...
// Execute executes the request
//  @return BackupAgentListResponse1Dot2
func (a *BackupV1BackupAgentsApiAPIService) ListBackupAgentsExecute(r BackupV1BackupAgentsApiAPIListBackupAgentsRequest) (*BackupAgentListResponse1Dot2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *BackupAgentListResponse1Dot2
	)
...
func (r BackupV1BackupAgentsApiAPIShowBackupAgentRequest) Execute() (*BackupAgentDetailResponse1Dot2, *http.Response, error) {
...
// Execute executes the request
//  @return BackupAgentDetailResponse1Dot2
func (a *BackupV1BackupAgentsApiAPIService) ShowBackupAgentExecute(r BackupV1BackupAgentsApiAPIShowBackupAgentRequest) (*BackupAgentDetailResponse1Dot2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *BackupAgentDetailResponse1Dot2
	)
