...
// size
func (r DirectConnectV1DirectConnectsApiAPIListDirectConnectsRequest) Size(size int32) DirectConnectV1DirectConnectsApiAPIListDirectConnectsRequest {
	r.size = &size
	return r
}

// page
func (r DirectConnectV1DirectConnectsApiAPIListDirectConnectsRequest) Page(page int32) DirectConnectV1DirectConnectsApiAPIListDirectConnectsRequest {
	r.page = &page
	return r
}
...
func (r DirectConnectV1DirectConnectsApiAPIListDirectConnectsRequest) Execute() (*DirectConnectListResponseV1Dot1, *http.Response, error) {
...
// Execute executes the request
//  @return DirectConnectListResponseV1Dot1
func (a *DirectConnectV1DirectConnectsApiAPIService) ListDirectConnectsExecute(r DirectConnectV1DirectConnectsApiAPIListDirectConnectsRequest) (*DirectConnectListResponseV1Dot1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DirectConnectListResponseV1Dot1
	)
