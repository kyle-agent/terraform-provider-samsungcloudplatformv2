...
func (r QuotaV1AccountQuotasAPIsAPIListAccountQuotaRequest) Execute() (*AccountQuotaListResponseV1dot1, *http.Response, error) {
...
//  @return AccountQuotaListResponseV1dot1
func (a *QuotaV1AccountQuotasAPIsAPIService) ListAccountQuotaExecute(r QuotaV1AccountQuotasAPIsAPIListAccountQuotaRequest) (*AccountQuotaListResponseV1dot1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AccountQuotaListResponseV1dot1
	)
    ...
    localVarHeaderParams["Scp-API-Version"] = "quota 1.4"
	version := "v1.4"
	versionFlag := false
...
func (r QuotaV1AccountQuotasAPIsAPIShowAccountQuotaRequest) Execute() (*AccountQuotaShowResponseV1dot1, *http.Response, error) {
...
// Execute executes the request
//  @return AccountQuotaShowResponseV1dot1
func (a *QuotaV1AccountQuotasAPIsAPIService) ShowAccountQuotaExecute(r QuotaV1AccountQuotasAPIsAPIShowAccountQuotaRequest) (*AccountQuotaShowResponseV1dot1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AccountQuotaShowResponseV1dot1
	)
