...
func NewReplicaItem(name string, region NullableString, replicaState NullableString, replicaStateDetail NullableString, syncedAt NullableString) *ReplicaItem {
	this := ReplicaItem{}
	this.Name = name
	this.Region = region
...
func (o *ReplicaItem) GetRegion() string {
...
func (o *ReplicaItem) GetRegionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ReplicaItem) SetRegion(v string) {
	o.Region.Set(&v)
}
