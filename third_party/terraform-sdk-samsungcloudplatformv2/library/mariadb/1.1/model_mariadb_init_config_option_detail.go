...
func (o *MariadbInitConfigOptionDetail) GetOriginRegion() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *MariadbInitConfigOptionDetail) GetOriginRegionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MariadbInitConfigOptionDetail) HasOriginRegion() bool {
