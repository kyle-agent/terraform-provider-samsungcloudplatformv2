...
// checks if the PageResponseAlarmAddrBookDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageResponseAlarmAddrBookDto{}
...
func NewPageResponseAlarmAddrBookDto() *PageResponseAlarmAddrBookDto {
	this := PageResponseAlarmAddrBookDto{}
	return &this
}
...
type NullablePageResponseAlarmAddrBookDto struct {
	value *PageResponseAlarmAddrBookDto
	isSet bool
}

func (v NullablePageResponseAlarmAddrBookDto) Get() *PageResponseAlarmAddrBookDto {
	return v.value
}

func (v *NullablePageResponseAlarmAddrBookDto) Set(val *PageResponseAlarmAddrBookDto) {
	v.value = val
	v.isSet = true
}

func (v NullablePageResponseAlarmAddrBookDto) IsSet() bool {
	return v.isSet
}

func (v *NullablePageResponseAlarmAddrBookDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageResponseAlarmAddrBookDto(val *PageResponseAlarmAddrBookDto) *NullablePageResponseAlarmAddrBookDto {
	return &NullablePageResponseAlarmAddrBookDto{value: val, isSet: true}
}
