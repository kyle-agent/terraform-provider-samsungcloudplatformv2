...
// checks if the PageResponseAlarmAddrBookMemberDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageResponseAlarmAddrBookMemberDto{}
...
func NewPageResponseAlarmAddrBookMemberDto() *PageResponseAlarmAddrBookMemberDto {
	this := PageResponseAlarmAddrBookMemberDto{}
	return &this
}
...
func (o *PageResponseAlarmAddrBookMemberDto) GetContents() []AlarmAddrBookMemberDto {
	if o == nil || IsNil(o.Contents) {
		var ret []AlarmAddrBookMemberDto
		return ret
	}
	return o.Contents
}
...
type NullablePageResponseAlarmAddrBookMemberDto struct {
	value *PageResponseAlarmAddrBookMemberDto
	isSet bool
}

func (v NullablePageResponseAlarmAddrBookMemberDto) Get() *PageResponseAlarmAddrBookMemberDto {
	return v.value
}

func (v *NullablePageResponseAlarmAddrBookMemberDto) Set(val *PageResponseAlarmAddrBookMemberDto) {
	v.value = val
	v.isSet = true
}

func (v NullablePageResponseAlarmAddrBookMemberDto) IsSet() bool {
	return v.isSet
}

func (v *NullablePageResponseAlarmAddrBookMemberDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageResponseAlarmAddrBookMemberDto(val *PageResponseAlarmAddrBookMemberDto) *NullablePageResponseAlarmAddrBookMemberDto {
	return &NullablePageResponseAlarmAddrBookMemberDto{value: val, isSet: true}
}

func (v NullablePageResponseAlarmAddrBookMemberDto) MarshalJSON() ([]byte, error) {
