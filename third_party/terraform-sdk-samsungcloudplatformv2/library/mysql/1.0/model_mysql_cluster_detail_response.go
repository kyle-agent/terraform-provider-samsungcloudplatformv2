...
// checks if the MysqlClusterDetailResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlClusterDetailResponse{}

// MysqlClusterDetailResponse struct for MysqlClusterDetailResponse
...
type _MysqlClusterDetailResponse MysqlClusterDetailResponse

// NewMysqlClusterDetailResponse instantiates a new MysqlClusterDetailResponse object
...
func NewMysqlClusterDetailResponse(accountId string, createdAt time.Time, createdBy string, dbaasEngine string, dbaasEngineVersionName string, id string, initConfigOption MysqlInitConfigOptionResponseDetail, instanceGroups []InstanceGroupResponse, modifiedAt time.Time, modifiedBy string, name string, productImageType string, productType ProductType, roleType NullableClusterRoleType, serviceState ServiceState, softwareVersion string, subnetId string, timezone string) *MysqlClusterDetailResponse {
	this := MysqlClusterDetailResponse{}
...
func (o *MysqlClusterDetailResponse) SetDbaasEngine(v string) {
	o.DbaasEngine = v
}
...
func (o *MysqlClusterDetailResponse) HasInstanceCount() bool {
	if o != nil && !IsNil(o.InstanceCount) {
		return true
	}
...
func (o *MysqlClusterDetailResponse) SetMaintenanceOptionNil() {
...
func (o *MysqlClusterDetailResponse) SetName(v string) {
	o.Name = v
}
...
func (o *MysqlClusterDetailResponse) SetOriginClusterIdNil() {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *MysqlClusterDetailResponse) GetReplicasOk() ([]string, bool) {
...
func (o *MysqlClusterDetailResponse) SetSubnetId(v string) {
	o.SubnetId = v
}
...
func (o *MysqlClusterDetailResponse) SetVipPublicIpAddressNil() {
...
func (o *MysqlClusterDetailResponse) SetVipPublicIpIdNil() {
...
func (o *MysqlClusterDetailResponse) SetVirtualIpAddressNil() {
...
func (o MysqlClusterDetailResponse) MarshalJSON() ([]byte, error) {
...
func (o MysqlClusterDetailResponse) ToMap() (map[string]interface{}, error) {
...
func (o *MysqlClusterDetailResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varMysqlClusterDetailResponse := _MysqlClusterDetailResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMysqlClusterDetailResponse)

	if err != nil {
		return err
	}

	*o = MysqlClusterDetailResponse(varMysqlClusterDetailResponse)

	return err
}

type NullableMysqlClusterDetailResponse struct {
	value *MysqlClusterDetailResponse
	isSet bool
}

func (v NullableMysqlClusterDetailResponse) Get() *MysqlClusterDetailResponse {
	return v.value
}

func (v *NullableMysqlClusterDetailResponse) Set(val *MysqlClusterDetailResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMysqlClusterDetailResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMysqlClusterDetailResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMysqlClusterDetailResponse(val *MysqlClusterDetailResponse) *NullableMysqlClusterDetailResponse {
	return &NullableMysqlClusterDetailResponse{value: val, isSet: true}
}

func (v NullableMysqlClusterDetailResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMysqlClusterDetailResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
