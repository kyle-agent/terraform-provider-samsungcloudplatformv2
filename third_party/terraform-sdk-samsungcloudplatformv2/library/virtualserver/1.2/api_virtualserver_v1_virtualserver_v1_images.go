...
func (r VirtualserverV1VirtualserverV1ImagesAPIListImagesRequest) Execute() (*ImageListResponseV1Dot2, *http.Response, error) {
...
func (a *VirtualserverV1VirtualserverV1ImagesAPIService) ListImagesExecute(r VirtualserverV1VirtualserverV1ImagesAPIListImagesRequest) (*ImageListResponseV1Dot2, *http.Response, error) {
	var (
