...
// checks if the ImageShowResponseV1Dot3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageShowResponseV1Dot3{}

// ImageShowResponseV1Dot3 struct for ImageShowResponseV1Dot3
type ImageShowResponseV1Dot3 struct {
	...
	ScpSupportedClassTypes NullableString `json:"scp_supported_class_types,omitempty"`
...
type _ImageShowResponseV1Dot3 ImageShowResponseV1Dot3

// NewImageShowResponseV1Dot3 instantiates a new ImageShowResponseV1Dot3 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewImageShowResponseV1Dot3(containerFormat string, createdAt string, diskFormat string, file string, id string, minDisk int32, minRam int32, name string, osHidden bool, owner string, protected bool, status string, updatedAt string, visibility string) *ImageShowResponseV1Dot3 {
	this := ImageShowResponseV1Dot3{}
...
// NewImageShowResponseV1Dot3WithDefaults instantiates a new ImageShowResponseV1Dot3 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewImageShowResponseV1Dot3WithDefaults() *ImageShowResponseV1Dot3 {
	this := ImageShowResponseV1Dot3{}
	return &this
}

// GetChecksum returns the Checksum field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ImageShowResponseV1Dot3) GetChecksum() string {
...
func (o *ImageShowResponseV1Dot3) GetChecksumOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) HasChecksum() bool {
...
// and a boolean to check if the value has been set.
func (o *ImageShowResponseV1Dot3) GetContainerFormatOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) SetContainerFormat(v string) {
	o.ContainerFormat = v
}

// GetCreatedAt returns the CreatedAt field value
func (o *ImageShowResponseV1Dot3) GetCreatedAt() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ImageShowResponseV1Dot3) GetCreatedAtOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) SetCreatedAt(v string) {
	o.CreatedAt = v
}

// GetDiskFormat returns the DiskFormat field value
func (o *ImageShowResponseV1Dot3) GetDiskFormat() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ImageShowResponseV1Dot3) GetDiskFormatOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) SetDiskFormat(v string) {
	o.DiskFormat = v
}

// GetFile returns the File field value
func (o *ImageShowResponseV1Dot3) GetFile() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ImageShowResponseV1Dot3) GetFileOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.File, true
...
func (o *ImageShowResponseV1Dot3) SetFile(v string) {
	o.File = v
}

// GetId returns the Id field value
func (o *ImageShowResponseV1Dot3) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ImageShowResponseV1Dot3) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *ImageShowResponseV1Dot3) SetId(v string) {
	o.Id = v
}

// GetMinDisk returns the MinDisk field value
func (o *ImageShowResponseV1Dot3) GetMinDisk() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ImageShowResponseV1Dot3) GetMinDiskOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) SetMinDisk(v int32) {
	o.MinDisk = v
}

// GetMinRam returns the MinRam field value
func (o *ImageShowResponseV1Dot3) GetMinRam() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ImageShowResponseV1Dot3) GetMinRamOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) SetMinRam(v int32) {
	o.MinRam = v
}

// GetName returns the Name field value
func (o *ImageShowResponseV1Dot3) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ImageShowResponseV1Dot3) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ImageShowResponseV1Dot3) GetOsDistroOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) HasOsDistro() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ImageShowResponseV1Dot3) GetOsHashAlgoOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) HasOsHashAlgo() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ImageShowResponseV1Dot3) GetOsHashValueOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) HasOsHashValue() bool {
...
// and a boolean to check if the value has been set.
func (o *ImageShowResponseV1Dot3) GetOsHiddenOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) SetOsHidden(v bool) {
	o.OsHidden = v
}

// GetOwner returns the Owner field value
func (o *ImageShowResponseV1Dot3) GetOwner() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ImageShowResponseV1Dot3) GetOwnerOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Owner, true
...
func (o *ImageShowResponseV1Dot3) SetOwner(v string) {
	o.Owner = v
}
...
func (o *ImageShowResponseV1Dot3) GetOwnerAccountName() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ImageShowResponseV1Dot3) GetOwnerAccountNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) HasOwnerAccountName() bool {
...
func (o *ImageShowResponseV1Dot3) SetOwnerAccountName(v string) {
	o.OwnerAccountName.Set(&v)
}
// SetOwnerAccountNameNil sets the value for OwnerAccountName to be an explicit nil
func (o *ImageShowResponseV1Dot3) SetOwnerAccountNameNil() {
...
func (o *ImageShowResponseV1Dot3) UnsetOwnerAccountName() {
...
func (o *ImageShowResponseV1Dot3) GetOwnerUserName() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ImageShowResponseV1Dot3) GetOwnerUserNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) HasOwnerUserName() bool {
...
// and a boolean to check if the value has been set.
func (o *ImageShowResponseV1Dot3) GetProtectedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) SetProtected(v bool) {
	o.Protected = v
}
...
func (o *ImageShowResponseV1Dot3) GetRootDeviceName() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ImageShowResponseV1Dot3) GetRootDeviceNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) HasRootDeviceName() bool {
...
func (o *ImageShowResponseV1Dot3) GetScpGpuDriver() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ImageShowResponseV1Dot3) GetScpGpuDriverOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) HasScpGpuDriver() bool {
...
func (o *ImageShowResponseV1Dot3) GetScpImageType() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ImageShowResponseV1Dot3) GetScpImageTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) HasScpImageType() bool {
...
func (o *ImageShowResponseV1Dot3) GetScpK8sVersion() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ImageShowResponseV1Dot3) GetScpK8sVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) HasScpK8sVersion() bool {
...
func (o *ImageShowResponseV1Dot3) GetScpOriginalImageType() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ImageShowResponseV1Dot3) GetScpOriginalImageTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) HasScpOriginalImageType() bool {
...
func (o *ImageShowResponseV1Dot3) SetScpOriginalImageType(v string) {
	o.ScpOriginalImageType.Set(&v)
}
// SetScpOriginalImageTypeNil sets the value for ScpOriginalImageType to be an explicit nil
func (o *ImageShowResponseV1Dot3) SetScpOriginalImageTypeNil() {
...
func (o *ImageShowResponseV1Dot3) UnsetScpOriginalImageType() {
...
func (o *ImageShowResponseV1Dot3) GetScpOsBuildVersion() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ImageShowResponseV1Dot3) GetScpOsBuildVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) HasScpOsBuildVersion() bool {
...
func (o *ImageShowResponseV1Dot3) SetScpOsBuildVersion(v string) {
	o.ScpOsBuildVersion.Set(&v)
}
// SetScpOsBuildVersionNil sets the value for ScpOsBuildVersion to be an explicit nil
func (o *ImageShowResponseV1Dot3) SetScpOsBuildVersionNil() {
...
func (o *ImageShowResponseV1Dot3) UnsetScpOsBuildVersion() {
...
func (o *ImageShowResponseV1Dot3) GetScpOsVersion() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ImageShowResponseV1Dot3) GetScpOsVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) HasScpOsVersion() bool {
...
func (o *ImageShowResponseV1Dot3) SetScpOsVersion(v string) {
	o.ScpOsVersion.Set(&v)
}
// SetScpOsVersionNil sets the value for ScpOsVersion to be an explicit nil
func (o *ImageShowResponseV1Dot3) SetScpOsVersionNil() {
	o.ScpOsVersion.Set(nil)
}

// UnsetScpOsVersion ensures that no value is present for ScpOsVersion, not even an explicit nil
func (o *ImageShowResponseV1Dot3) UnsetScpOsVersion() {
	o.ScpOsVersion.Unset()
}

// GetScpSupportedClassTypes returns the ScpSupportedClassTypes field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ImageShowResponseV1Dot3) GetScpSupportedClassTypes() string {
	if o == nil || IsNil(o.ScpSupportedClassTypes.Get()) {
		var ret string
		return ret
	}
	return *o.ScpSupportedClassTypes.Get()
}

// GetScpSupportedClassTypesOk returns a tuple with the ScpSupportedClassTypes field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ImageShowResponseV1Dot3) GetScpSupportedClassTypesOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return o.ScpSupportedClassTypes.Get(), o.ScpSupportedClassTypes.IsSet()
}

// HasScpSupportedClassTypes returns a boolean if a field has been set.
func (o *ImageShowResponseV1Dot3) HasScpSupportedClassTypes() bool {
	if o != nil && o.ScpSupportedClassTypes.IsSet() {
		return true
	}
...
// SetScpSupportedClassTypes gets a reference to the given NullableString and assigns it to the ScpSupportedClassTypes field.
func (o *ImageShowResponseV1Dot3) SetScpSupportedClassTypes(v string) {
	o.ScpSupportedClassTypes.Set(&v)
}
// SetScpSupportedClassTypesNil sets the value for ScpSupportedClassTypes to be an explicit nil
func (o *ImageShowResponseV1Dot3) SetScpSupportedClassTypesNil() {
	o.ScpSupportedClassTypes.Set(nil)
}

// UnsetScpSupportedClassTypes ensures that no value is present for ScpSupportedClassTypes, not even an explicit nil
func (o *ImageShowResponseV1Dot3) UnsetScpSupportedClassTypes() {
	o.ScpSupportedClassTypes.Unset()
}

// GetSize returns the Size field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ImageShowResponseV1Dot3) GetSize() int64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ImageShowResponseV1Dot3) GetSizeOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) HasSize() bool {
...
func (o *ImageShowResponseV1Dot3) SetSize(v int64) {
	o.Size.Set(&v)
}
// SetSizeNil sets the value for Size to be an explicit nil
func (o *ImageShowResponseV1Dot3) SetSizeNil() {
	o.Size.Set(nil)
}

// UnsetSize ensures that no value is present for Size, not even an explicit nil
func (o *ImageShowResponseV1Dot3) UnsetSize() {
	o.Size.Unset()
}

// GetStatus returns the Status field value
func (o *ImageShowResponseV1Dot3) GetStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ImageShowResponseV1Dot3) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) SetStatus(v string) {
	o.Status = v
}

// GetUpdatedAt returns the UpdatedAt field value
func (o *ImageShowResponseV1Dot3) GetUpdatedAt() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ImageShowResponseV1Dot3) GetUpdatedAtOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) SetUpdatedAt(v string) {
	o.UpdatedAt = v
}

// GetUrl returns the Url field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ImageShowResponseV1Dot3) GetUrl() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ImageShowResponseV1Dot3) GetUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) HasUrl() bool {
...
func (o *ImageShowResponseV1Dot3) SetUrl(v string) {
	o.Url.Set(&v)
}
// SetUrlNil sets the value for Url to be an explicit nil
func (o *ImageShowResponseV1Dot3) SetUrlNil() {
	o.Url.Set(nil)
}

// UnsetUrl ensures that no value is present for Url, not even an explicit nil
func (o *ImageShowResponseV1Dot3) UnsetUrl() {
	o.Url.Unset()
}

// GetVirtualSize returns the VirtualSize field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ImageShowResponseV1Dot3) GetVirtualSize() int64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ImageShowResponseV1Dot3) GetVirtualSizeOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) HasVirtualSize() bool {
...
func (o *ImageShowResponseV1Dot3) SetVirtualSize(v int64) {
	o.VirtualSize.Set(&v)
}
// SetVirtualSizeNil sets the value for VirtualSize to be an explicit nil
func (o *ImageShowResponseV1Dot3) SetVirtualSizeNil() {
	o.VirtualSize.Set(nil)
}

// UnsetVirtualSize ensures that no value is present for VirtualSize, not even an explicit nil
func (o *ImageShowResponseV1Dot3) UnsetVirtualSize() {
	o.VirtualSize.Unset()
}

// GetVisibility returns the Visibility field value
func (o *ImageShowResponseV1Dot3) GetVisibility() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ImageShowResponseV1Dot3) GetVisibilityOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ImageShowResponseV1Dot3) GetVolumesOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImageShowResponseV1Dot3) HasVolumes() bool {
...
func (o *ImageShowResponseV1Dot3) SetVolumes(v string) {
	o.Volumes.Set(&v)
}
// SetVolumesNil sets the value for Volumes to be an explicit nil
func (o *ImageShowResponseV1Dot3) SetVolumesNil() {
	o.Volumes.Set(nil)
}

// UnsetVolumes ensures that no value is present for Volumes, not even an explicit nil
func (o *ImageShowResponseV1Dot3) UnsetVolumes() {
	o.Volumes.Unset()
}

func (o ImageShowResponseV1Dot3) MarshalJSON() ([]byte, error) {
...
func (o ImageShowResponseV1Dot3) ToMap() (map[string]interface{}, error) {
	...
	if o.ScpSupportedClassTypes.IsSet() {
		toSerialize["scp_supported_class_types"] = o.ScpSupportedClassTypes.Get()
	}
	if o.Size.IsSet() {
...
func (o *ImageShowResponseV1Dot3) UnmarshalJSON(data []byte) (err error) {
	...
	varImageShowResponseV1Dot3 := _ImageShowResponseV1Dot3{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varImageShowResponseV1Dot3)

	if err != nil {
		return err
	}

	*o = ImageShowResponseV1Dot3(varImageShowResponseV1Dot3)

	return err
}

type NullableImageShowResponseV1Dot3 struct {
	value *ImageShowResponseV1Dot3
	isSet bool
}

func (v NullableImageShowResponseV1Dot3) Get() *ImageShowResponseV1Dot3 {
	return v.value
}

func (v *NullableImageShowResponseV1Dot3) Set(val *ImageShowResponseV1Dot3) {
	v.value = val
	v.isSet = true
}

func (v NullableImageShowResponseV1Dot3) IsSet() bool {
	return v.isSet
}

func (v *NullableImageShowResponseV1Dot3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageShowResponseV1Dot3(val *ImageShowResponseV1Dot3) *NullableImageShowResponseV1Dot3 {
	return &NullableImageShowResponseV1Dot3{value: val, isSet: true}
}

func (v NullableImageShowResponseV1Dot3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageShowResponseV1Dot3) UnmarshalJSON(src []byte) error {
	v.isSet = true
