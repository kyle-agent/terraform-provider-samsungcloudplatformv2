...
func (r VirtualserverV1VolumesApiAPICreateVolumeRequest) VolumeCreateRequestV1Dot2(volumeCreateRequestV1Dot2 VolumeCreateRequestV1Dot2) VirtualserverV1VolumesApiAPICreateVolumeRequest {
	r.volumeCreateRequestV1Dot2 = &volumeCreateRequestV1Dot2
	return r
}

func (r VirtualserverV1VolumesApiAPICreateVolumeRequest) Execute() (*VolumeShowResponseV1Dot2, *http.Response, error) {
...
//  @return VolumeShowResponseV1Dot2
func (a *VirtualserverV1VolumesApiAPIService) CreateVolumeExecute(r VirtualserverV1VolumesApiAPICreateVolumeRequest) (*VolumeShowResponseV1Dot2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *VolumeShowResponseV1Dot2
	)
...
func (r VirtualserverV1VolumesApiAPIExtendVolumeRequest) Execute() (*VolumeShowResponseV1Dot2, *http.Response, error) {
...
// Execute executes the request
//  @return VolumeShowResponseV1Dot2
func (a *VirtualserverV1VolumesApiAPIService) ExtendVolumeExecute(r VirtualserverV1VolumesApiAPIExtendVolumeRequest) (*VolumeShowResponseV1Dot2, *http.Response, error) {
	var (
...
func (r VirtualserverV1VolumesApiAPIListVolumesRequest) Execute() (*VolumeListResponseV1Dot2, *http.Response, error) {
...
// Execute executes the request
//  @return VolumeListResponseV1Dot2
func (a *VirtualserverV1VolumesApiAPIService) ListVolumesExecute(r VirtualserverV1VolumesApiAPIListVolumesRequest) (*VolumeListResponseV1Dot2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *VolumeListResponseV1Dot2
	)
...
type VirtualserverV1VolumesApiAPISetVolumeQosRequest struct {
	ctx context.Context
	ApiService *VirtualserverV1VolumesApiAPIService
	volumeId string
	volumeSetQosRequest *VolumeSetQosRequest
}

func (r VirtualserverV1VolumesApiAPISetVolumeQosRequest) VolumeSetQosRequest(volumeSetQosRequest VolumeSetQosRequest) VirtualserverV1VolumesApiAPISetVolumeQosRequest {
	r.volumeSetQosRequest = &volumeSetQosRequest
	return r
}

func (r VirtualserverV1VolumesApiAPISetVolumeQosRequest) Execute() (*http.Response, error) {
...
Set Volume Qos
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param volumeId Volume ID
 @return VirtualserverV1VolumesApiAPISetVolumeQosRequest
*/
func (a *VirtualserverV1VolumesApiAPIService) SetVolumeQos(ctx context.Context, volumeId string) VirtualserverV1VolumesApiAPISetVolumeQosRequest {
	return VirtualserverV1VolumesApiAPISetVolumeQosRequest{
		ApiService: a,
		ctx: ctx,
		volumeId: volumeId,
...
// Execute executes the request
func (a *VirtualserverV1VolumesApiAPIService) SetVolumeQosExecute(r VirtualserverV1VolumesApiAPISetVolumeQosRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.volumeSetQosRequest == nil {
		return nil, reportError("volumeSetQosRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.volumeSetQosRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["X-Auth-Token"]; ok {
...
func (r VirtualserverV1VolumesApiAPIShowVolumeRequest) Execute() (*VolumeShowResponseV1Dot2, *http.Response, error) {
...
// Execute executes the request
//  @return VolumeShowResponseV1Dot2
func (a *VirtualserverV1VolumesApiAPIService) ShowVolumeExecute(r VirtualserverV1VolumesApiAPIShowVolumeRequest) (*VolumeShowResponseV1Dot2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VirtualserverV1VolumesApiAPIUpdateVolumeRequest) Execute() (*VolumeShowResponseV1Dot2, *http.Response, error) {
...
// Execute executes the request
//  @return VolumeShowResponseV1Dot2
func (a *VirtualserverV1VolumesApiAPIService) UpdateVolumeExecute(r VirtualserverV1VolumesApiAPIUpdateVolumeRequest) (*VolumeShowResponseV1Dot2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
