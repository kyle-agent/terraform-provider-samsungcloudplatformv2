...
type VirtualserverV1VolumeTransferApiAPIAcceptVolumeTransferRequest struct {
	...
	transferId string
	volumeTransferAcceptRequest *VolumeTransferAcceptRequest
}

func (r VirtualserverV1VolumeTransferApiAPIAcceptVolumeTransferRequest) VolumeTransferAcceptRequest(volumeTransferAcceptRequest VolumeTransferAcceptRequest) VirtualserverV1VolumeTransferApiAPIAcceptVolumeTransferRequest {
	r.volumeTransferAcceptRequest = &volumeTransferAcceptRequest
	return r
}
...
Accept a volume transfer.
 ...
 @param transferId Volume Transfer ID
...
func (a *VirtualserverV1VolumeTransferApiAPIService) AcceptVolumeTransferExecute(r VirtualserverV1VolumeTransferApiAPIAcceptVolumeTransferRequest) (*VolumeTransferAcceptResponse, *http.Response, error) {
	...
	if r.volumeTransferAcceptRequest == nil {
		return localVarReturnValue, nil, reportError("volumeTransferAcceptRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.volumeTransferAcceptRequest
	if r.ctx != nil {
