...
type AutoScalingGroupNotificationUpdateRequest struct {
	NotificationEvents []AsgNotificationEvent `json:"notification_events,omitempty"`
...
func (o *AutoScalingGroupNotificationUpdateRequest) GetNotificationEvents() []AsgNotificationEvent {
	if o == nil {
...
func (o *AutoScalingGroupNotificationUpdateRequest) GetNotificationEventsOk() ([]AsgNotificationEvent, bool) {
...
// SetNotificationEvents gets a reference to the given []AsgNotificationEvent and assigns it to the NotificationEvents field.
func (o *AutoScalingGroupNotificationUpdateRequest) SetNotificationEvents(v []AsgNotificationEvent) {
