...
func NewVolumeShowResponse(bootable bool, createdAt time.Time, encrypted bool, id string, multiattach bool, servers []VolumeServer, size int32, state string, userId string, volumeType string, volumeTypeId string) *VolumeShowResponse {
...
func (o *VolumeShowResponse) HasModifiedAt() bool {
...
func (o *VolumeShowResponse) SetModifiedAtNil() {
