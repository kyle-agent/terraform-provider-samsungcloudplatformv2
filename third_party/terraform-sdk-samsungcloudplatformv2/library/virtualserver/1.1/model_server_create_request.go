...
func (o *ServerCreateRequest) GetPartitionNumber() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ServerCreateRequest) GetPartitionNumberOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ServerCreateRequest) HasPartitionNumber() bool {
...
func (o *ServerCreateRequest) SetPartitionNumber(v int32) {
	o.PartitionNumber.Set(&v)
}

// SetPartitionNumberNil sets the value for PartitionNumber to be an explicit nil
func (o *ServerCreateRequest) SetPartitionNumberNil() {
...
func (o *ServerCreateRequest) UnsetPartitionNumber() {
