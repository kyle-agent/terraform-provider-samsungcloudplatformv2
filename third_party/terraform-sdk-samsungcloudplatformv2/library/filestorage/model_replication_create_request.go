...
type ReplicationCreateRequest struct {
	...
	BackupRetentionCount *int32         `json:"backup_retention_count,omitempty"`
...
// GetBackupRetentionCount returns the BackupRetentionCount field value if set, zero value otherwise.
func (o *ReplicationCreateRequest) GetBackupRetentionCount() int32 {
	if o == nil || IsNil(o.BackupRetentionCount) {
		var ret int32
		return ret
	}
	return *o.BackupRetentionCount
}
...
func (o *ReplicationCreateRequest) GetBackupRetentionCountOk() (*int32, bool) {
	...
	return o.BackupRetentionCount, true
}
...
// SetBackupRetentionCount gets a reference to the given int32 and assigns it to the BackupRetentionCount field.
func (o *ReplicationCreateRequest) SetBackupRetentionCount(v int32) {
	o.BackupRetentionCount = &v
}
...
func (o ReplicationCreateRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BackupRetentionCount) {
		toSerialize["backup_retention_count"] = o.BackupRetentionCount
	}
