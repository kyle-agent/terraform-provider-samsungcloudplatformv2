...
type SnapshotListResponse struct {
	...
	// Snapshot Total Size
	SnapshotSizeTotalByte NullableInt64 `json:"snapshot_size_total_byte,omitempty"`
...
func (o *SnapshotListResponse) GetSnapshotSizeTotalByte() int64 {
...
func (o *SnapshotListResponse) GetSnapshotSizeTotalByteOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
// SetSnapshotSizeTotalByte gets a reference to the given NullableInt64 and assigns it to the SnapshotSizeTotalByte field.
func (o *SnapshotListResponse) SetSnapshotSizeTotalByte(v int64) {
