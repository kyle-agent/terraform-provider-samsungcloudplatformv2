...
func (r FilestorageV1VolumeReplicationAPIsAPISetVolumeReplicationRequest) Execute() (*ReplicationUpdateResponse, *http.Response, error) {
...
// Execute executes the request
//
//	@return ReplicationUpdateResponse
func (a *FilestorageV1VolumeReplicationAPIsAPIService) SetVolumeReplicationExecute(r FilestorageV1VolumeReplicationAPIsAPISetVolumeReplicationRequest) (*ReplicationUpdateResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ReplicationUpdateResponse
	)
