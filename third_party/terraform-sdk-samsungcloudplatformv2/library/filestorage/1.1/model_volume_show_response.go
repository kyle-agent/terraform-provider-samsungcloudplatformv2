...
type VolumeShowResponse struct {
	...
	EndpointPath            NullableString `json:"endpoint_path,omitempty"`
	...
	// Volume Usage
	Usage NullableInt64 `json:"usage,omitempty"`
}
...
// GetEndpointPath returns the EndpointPath field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *VolumeShowResponse) GetEndpointPath() string {
	if o == nil || IsNil(o.EndpointPath.Get()) {
		var ret string
		return ret
	}
	return *o.EndpointPath.Get()
}

// GetEndpointPathOk returns a tuple with the EndpointPath field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetEndpointPath gets a reference to the given NullableString and assigns it to the EndpointPath field.
func (o *VolumeShowResponse) SetEndpointPath(v string) {
	o.EndpointPath.Set(&v)
}

// SetEndpointPathNil sets the value for EndpointPath to be an explicit nil
func (o *VolumeShowResponse) SetEndpointPathNil() {
	o.EndpointPath.Set(nil)
}
...
func (o *VolumeShowResponse) GetUsage() int64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *VolumeShowResponse) GetUsageOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
// SetUsage gets a reference to the given NullableInt64 and assigns it to the Usage field.
func (o *VolumeShowResponse) SetUsage(v int64) {
	o.Usage.Set(&v)
}
...
func (o VolumeShowResponse) ToMap() (map[string]interface{}, error) {
	...
	if o.EndpointPath.IsSet() {
		toSerialize["endpoint_path"] = o.EndpointPath.Get()
	}
