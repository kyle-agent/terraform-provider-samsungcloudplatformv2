...
// checks if the NodepoolCreateRequestV1Dot1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodepoolCreateRequestV1Dot1{}

// NodepoolCreateRequestV1Dot1 struct for NodepoolCreateRequestV1Dot1
type NodepoolCreateRequestV1Dot1 struct {
...
type _NodepoolCreateRequestV1Dot1 NodepoolCreateRequestV1Dot1

// NewNodepoolCreateRequestV1Dot1 instantiates a new NodepoolCreateRequestV1Dot1 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewNodepoolCreateRequestV1Dot1(clusterId string, imageOs string, imageOsVersion string, isAutoRecovery bool, isAutoScale bool, keypairName string, kubernetesVersion string, name string, serverTypeId string, volumeSize int32, volumeTypeName string) *NodepoolCreateRequestV1Dot1 {
	this := NodepoolCreateRequestV1Dot1{}
...
// NewNodepoolCreateRequestV1Dot1WithDefaults instantiates a new NodepoolCreateRequestV1Dot1 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewNodepoolCreateRequestV1Dot1WithDefaults() *NodepoolCreateRequestV1Dot1 {
	this := NodepoolCreateRequestV1Dot1{}
	return &this
}
...
func (o *NodepoolCreateRequestV1Dot1) GetAdvancedSettings() NodepoolAdvancedSettings {
...
func (o *NodepoolCreateRequestV1Dot1) GetAdvancedSettingsOk() (*NodepoolAdvancedSettings, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NodepoolCreateRequestV1Dot1) HasAdvancedSettings() bool {
...
func (o *NodepoolCreateRequestV1Dot1) SetAdvancedSettings(v NodepoolAdvancedSettings) {
	o.AdvancedSettings.Set(&v)
}
// SetAdvancedSettingsNil sets the value for AdvancedSettings to be an explicit nil
func (o *NodepoolCreateRequestV1Dot1) SetAdvancedSettingsNil() {
...
func (o *NodepoolCreateRequestV1Dot1) UnsetAdvancedSettings() {
	o.AdvancedSettings.Unset()
}

// GetClusterId returns the ClusterId field value
func (o *NodepoolCreateRequestV1Dot1) GetClusterId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NodepoolCreateRequestV1Dot1) GetClusterIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NodepoolCreateRequestV1Dot1) SetClusterId(v string) {
	o.ClusterId = v
}
...
func (o *NodepoolCreateRequestV1Dot1) GetCustomImageId() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *NodepoolCreateRequestV1Dot1) GetCustomImageIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NodepoolCreateRequestV1Dot1) HasCustomImageId() bool {
...
func (o *NodepoolCreateRequestV1Dot1) GetDesiredNodeCount() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *NodepoolCreateRequestV1Dot1) GetDesiredNodeCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NodepoolCreateRequestV1Dot1) HasDesiredNodeCount() bool {
...
func (o *NodepoolCreateRequestV1Dot1) SetDesiredNodeCount(v int32) {
	o.DesiredNodeCount.Set(&v)
}
// SetDesiredNodeCountNil sets the value for DesiredNodeCount to be an explicit nil
func (o *NodepoolCreateRequestV1Dot1) SetDesiredNodeCountNil() {
...
func (o *NodepoolCreateRequestV1Dot1) UnsetDesiredNodeCount() {
	o.DesiredNodeCount.Unset()
}

// GetImageOs returns the ImageOs field value
func (o *NodepoolCreateRequestV1Dot1) GetImageOs() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NodepoolCreateRequestV1Dot1) GetImageOsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NodepoolCreateRequestV1Dot1) SetImageOs(v string) {
	o.ImageOs = v
}

// GetImageOsVersion returns the ImageOsVersion field value
func (o *NodepoolCreateRequestV1Dot1) GetImageOsVersion() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NodepoolCreateRequestV1Dot1) GetImageOsVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NodepoolCreateRequestV1Dot1) SetImageOsVersion(v string) {
	o.ImageOsVersion = v
}

// GetIsAutoRecovery returns the IsAutoRecovery field value
func (o *NodepoolCreateRequestV1Dot1) GetIsAutoRecovery() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NodepoolCreateRequestV1Dot1) GetIsAutoRecoveryOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NodepoolCreateRequestV1Dot1) SetIsAutoRecovery(v bool) {
	o.IsAutoRecovery = v
}

// GetIsAutoScale returns the IsAutoScale field value
func (o *NodepoolCreateRequestV1Dot1) GetIsAutoScale() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NodepoolCreateRequestV1Dot1) GetIsAutoScaleOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NodepoolCreateRequestV1Dot1) SetIsAutoScale(v bool) {
	o.IsAutoScale = v
}

// GetKeypairName returns the KeypairName field value
func (o *NodepoolCreateRequestV1Dot1) GetKeypairName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NodepoolCreateRequestV1Dot1) GetKeypairNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NodepoolCreateRequestV1Dot1) SetKeypairName(v string) {
	o.KeypairName = v
}

// GetKubernetesVersion returns the KubernetesVersion field value
func (o *NodepoolCreateRequestV1Dot1) GetKubernetesVersion() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NodepoolCreateRequestV1Dot1) GetKubernetesVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NodepoolCreateRequestV1Dot1) SetKubernetesVersion(v string) {
	o.KubernetesVersion = v
}

// GetLabels returns the Labels field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *NodepoolCreateRequestV1Dot1) GetLabels() []NodepoolLabel {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *NodepoolCreateRequestV1Dot1) GetLabelsOk() ([]NodepoolLabel, bool) {
...
func (o *NodepoolCreateRequestV1Dot1) HasLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *NodepoolCreateRequestV1Dot1) GetMaxNodeCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NodepoolCreateRequestV1Dot1) HasMaxNodeCount() bool {
...
func (o *NodepoolCreateRequestV1Dot1) GetMinNodeCount() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *NodepoolCreateRequestV1Dot1) GetMinNodeCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NodepoolCreateRequestV1Dot1) HasMinNodeCount() bool {
...
// and a boolean to check if the value has been set.
func (o *NodepoolCreateRequestV1Dot1) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *NodepoolCreateRequestV1Dot1) SetName(v string) {
	o.Name = v
}
...
func (o *NodepoolCreateRequestV1Dot1) GetServerGroupId() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *NodepoolCreateRequestV1Dot1) GetServerGroupIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NodepoolCreateRequestV1Dot1) HasServerGroupId() bool {
...
// and a boolean to check if the value has been set.
func (o *NodepoolCreateRequestV1Dot1) GetServerTypeIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NodepoolCreateRequestV1Dot1) SetServerTypeId(v string) {
	o.ServerTypeId = v
}

// GetTaints returns the Taints field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *NodepoolCreateRequestV1Dot1) GetTaints() []NodepoolTaint {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *NodepoolCreateRequestV1Dot1) GetTaintsOk() ([]NodepoolTaint, bool) {
...
func (o *NodepoolCreateRequestV1Dot1) HasTaints() bool {
	if o != nil && !IsNil(o.Taints) {
		return true
	}
...
func (o *NodepoolCreateRequestV1Dot1) SetTaints(v []NodepoolTaint) {
	o.Taints = v
}

// GetVolumeSize returns the VolumeSize field value
func (o *NodepoolCreateRequestV1Dot1) GetVolumeSize() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NodepoolCreateRequestV1Dot1) GetVolumeSizeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NodepoolCreateRequestV1Dot1) SetVolumeSize(v int32) {
	o.VolumeSize = v
}

// GetVolumeTypeName returns the VolumeTypeName field value
func (o *NodepoolCreateRequestV1Dot1) GetVolumeTypeName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NodepoolCreateRequestV1Dot1) GetVolumeTypeNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NodepoolCreateRequestV1Dot1) SetVolumeTypeName(v string) {
	o.VolumeTypeName = v
}

func (o NodepoolCreateRequestV1Dot1) MarshalJSON() ([]byte, error) {
...
func (o NodepoolCreateRequestV1Dot1) ToMap() (map[string]interface{}, error) {
...
func (o *NodepoolCreateRequestV1Dot1) UnmarshalJSON(data []byte) (err error) {
	...
	varNodepoolCreateRequestV1Dot1 := _NodepoolCreateRequestV1Dot1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodepoolCreateRequestV1Dot1)

	if err != nil {
		return err
	}

	*o = NodepoolCreateRequestV1Dot1(varNodepoolCreateRequestV1Dot1)

	return err
}

type NullableNodepoolCreateRequestV1Dot1 struct {
	value *NodepoolCreateRequestV1Dot1
	isSet bool
}

func (v NullableNodepoolCreateRequestV1Dot1) Get() *NodepoolCreateRequestV1Dot1 {
	return v.value
}

func (v *NullableNodepoolCreateRequestV1Dot1) Set(val *NodepoolCreateRequestV1Dot1) {
	v.value = val
	v.isSet = true
}

func (v NullableNodepoolCreateRequestV1Dot1) IsSet() bool {
	return v.isSet
}

func (v *NullableNodepoolCreateRequestV1Dot1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodepoolCreateRequestV1Dot1(val *NodepoolCreateRequestV1Dot1) *NullableNodepoolCreateRequestV1Dot1 {
	return &NullableNodepoolCreateRequestV1Dot1{value: val, isSet: true}
}

func (v NullableNodepoolCreateRequestV1Dot1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodepoolCreateRequestV1Dot1) UnmarshalJSON(src []byte) error {
	v.isSet = true
