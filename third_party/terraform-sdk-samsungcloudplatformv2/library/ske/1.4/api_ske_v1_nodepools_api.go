...
type SkeV1NodepoolsApiAPICreateNodepoolRequest struct {
	...
	nodepoolCreateRequestV1Dot4 *NodepoolCreateRequestV1Dot4
}

func (r SkeV1NodepoolsApiAPICreateNodepoolRequest) NodepoolCreateRequestV1Dot4(nodepoolCreateRequestV1Dot4 NodepoolCreateRequestV1Dot4) SkeV1NodepoolsApiAPICreateNodepoolRequest {
	r.nodepoolCreateRequestV1Dot4 = &nodepoolCreateRequestV1Dot4
	return r
}

func (r SkeV1NodepoolsApiAPICreateNodepoolRequest) Execute() (*NodepoolShowResponseV1Dot4, *http.Response, error) {
...
//  @return NodepoolShowResponseV1Dot4
func (a *SkeV1NodepoolsApiAPIService) CreateNodepoolExecute(r SkeV1NodepoolsApiAPICreateNodepoolRequest) (*NodepoolShowResponseV1Dot4, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *NodepoolShowResponseV1Dot4
	)
	...
	if r.nodepoolCreateRequestV1Dot4 == nil {
		return localVarReturnValue, nil, reportError("nodepoolCreateRequestV1Dot4 is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.nodepoolCreateRequestV1Dot4
	if r.ctx != nil {
...
func (r SkeV1NodepoolsApiAPIListNodepoolsRequest) Execute() (*NodepoolListResponseV1Dot4, *http.Response, error) {
...
// Execute executes the request
//  @return NodepoolListResponseV1Dot4
func (a *SkeV1NodepoolsApiAPIService) ListNodepoolsExecute(r SkeV1NodepoolsApiAPIListNodepoolsRequest) (*NodepoolListResponseV1Dot4, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *NodepoolListResponseV1Dot4
	)
...
type SkeV1NodepoolsApiAPISetNodepoolLinkedResourcesRequest struct {
	ctx context.Context
	ApiService *SkeV1NodepoolsApiAPIService
	nodepoolId string
	nodepoolLinkedResourcesSetRequest *NodepoolLinkedResourcesSetRequest
}

func (r SkeV1NodepoolsApiAPISetNodepoolLinkedResourcesRequest) NodepoolLinkedResourcesSetRequest(nodepoolLinkedResourcesSetRequest NodepoolLinkedResourcesSetRequest) SkeV1NodepoolsApiAPISetNodepoolLinkedResourcesRequest {
	r.nodepoolLinkedResourcesSetRequest = &nodepoolLinkedResourcesSetRequest
	return r
}

func (r SkeV1NodepoolsApiAPISetNodepoolLinkedResourcesRequest) Execute() (*AsyncResponse, *http.Response, error) {
	return r.ApiService.SetNodepoolLinkedResourcesExecute(r)
}

/*
SetNodepoolLinkedResources Set Nodepool Linked Resources

set nodepool linked resources

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param nodepoolId Nodepool ID
 @return SkeV1NodepoolsApiAPISetNodepoolLinkedResourcesRequest
*/
func (a *SkeV1NodepoolsApiAPIService) SetNodepoolLinkedResources(ctx context.Context, nodepoolId string) SkeV1NodepoolsApiAPISetNodepoolLinkedResourcesRequest {
	return SkeV1NodepoolsApiAPISetNodepoolLinkedResourcesRequest{
		ApiService: a,
		ctx: ctx,
		nodepoolId: nodepoolId,
...
// Execute executes the request
//  @return AsyncResponse
func (a *SkeV1NodepoolsApiAPIService) SetNodepoolLinkedResourcesExecute(r SkeV1NodepoolsApiAPISetNodepoolLinkedResourcesRequest) (*AsyncResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := basePath + "/v1/nodepools/{nodepool_id}/linked-resources"
	localVarPath = strings.Replace(localVarPath, "{"+"nodepool_id"+"}", url.PathEscape(parameterValueToString(r.nodepoolId, "nodepoolId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.nodepoolLinkedResourcesSetRequest == nil {
		return localVarReturnValue, nil, reportError("nodepoolLinkedResourcesSetRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.nodepoolLinkedResourcesSetRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["X-Auth-Token"]; ok {
...
type SkeV1NodepoolsApiAPISetNodepoolUpgradeRequest struct {
	...
	ApiService *SkeV1NodepoolsApiAPIService
	nodepoolId string
	nodepoolUpgradeSetRequestV1Dot4 *NodepoolUpgradeSetRequestV1Dot4
}

func (r SkeV1NodepoolsApiAPISetNodepoolUpgradeRequest) NodepoolUpgradeSetRequestV1Dot4(nodepoolUpgradeSetRequestV1Dot4 NodepoolUpgradeSetRequestV1Dot4) SkeV1NodepoolsApiAPISetNodepoolUpgradeRequest {
	r.nodepoolUpgradeSetRequestV1Dot4 = &nodepoolUpgradeSetRequestV1Dot4
	return r
}
...
func (a *SkeV1NodepoolsApiAPIService) SetNodepoolUpgradeExecute(r SkeV1NodepoolsApiAPISetNodepoolUpgradeRequest) (*AsyncResponse, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.nodepoolUpgradeSetRequestV1Dot4 == nil {
		return localVarReturnValue, nil, reportError("nodepoolUpgradeSetRequestV1Dot4 is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.nodepoolUpgradeSetRequestV1Dot4
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["X-Auth-Token"]; ok {
...
func (r SkeV1NodepoolsApiAPIShowNodepoolRequest) Execute() (*NodepoolShowResponseV1Dot4, *http.Response, error) {
...
// Execute executes the request
//  @return NodepoolShowResponseV1Dot4
func (a *SkeV1NodepoolsApiAPIService) ShowNodepoolExecute(r SkeV1NodepoolsApiAPIShowNodepoolRequest) (*NodepoolShowResponseV1Dot4, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
