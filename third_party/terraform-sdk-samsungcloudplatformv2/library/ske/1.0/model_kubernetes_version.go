...
func (dst *KubernetesVersion) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(KubernetesVersion)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *KubernetesVersion) MarshalJSON() ([]byte, error) {
