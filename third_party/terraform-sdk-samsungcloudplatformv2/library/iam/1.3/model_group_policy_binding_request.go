...
// checks if the GroupPolicyBindingRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupPolicyBindingRequest{}
...
type _GroupPolicyBindingRequest GroupPolicyBindingRequest
...
func NewGroupPolicyBindingRequest(policyIds []string) *GroupPolicyBindingRequest {
	this := GroupPolicyBindingRequest{}
...
func (o *GroupPolicyBindingRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupPolicyBindingRequest := _GroupPolicyBindingRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGroupPolicyBindingRequest)

	if err != nil {
		return err
	}

	*o = GroupPolicyBindingRequest(varGroupPolicyBindingRequest)

	return err
}

type NullableGroupPolicyBindingRequest struct {
	value *GroupPolicyBindingRequest
	isSet bool
}
...
func NewNullableGroupPolicyBindingRequest(val *GroupPolicyBindingRequest) *NullableGroupPolicyBindingRequest {
	return &NullableGroupPolicyBindingRequest{value: val, isSet: true}
}
