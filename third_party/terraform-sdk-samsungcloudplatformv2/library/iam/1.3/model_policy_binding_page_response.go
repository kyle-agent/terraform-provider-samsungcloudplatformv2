...
type PolicyBindingPageResponse struct {
	...
	Groups NullableGroup `json:"groups,omitempty"`
	// page
	Page int32 `json:"page"`
	// Policy ID
	PolicyId *string      `json:"policy_id,omitempty"`
	Roles    NullableRole `json:"roles,omitempty"`
	// size
	Size  int32                `json:"size"`
	Sort  []string             `json:"sort,omitempty"`
	Users NullableUserResponse `json:"users,omitempty"`
}
...
func (o *PolicyBindingPageResponse) GetGroups() Group {
...
func (o *PolicyBindingPageResponse) GetGroupsOk() (*Group, bool) {
	if o == nil {
		return nil, false
	}
...
// SetGroups gets a reference to the given NullableGroup and assigns it to the Groups field.
func (o *PolicyBindingPageResponse) SetGroups(v Group) {
	o.Groups.Set(&v)
}

// SetGroupsNil sets the value for Groups to be an explicit nil
func (o *PolicyBindingPageResponse) SetGroupsNil() {
	o.Groups.Set(nil)
}
...
func (o *PolicyBindingPageResponse) GetRoles() Role {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PolicyBindingPageResponse) GetRolesOk() (*Role, bool) {
	if o == nil {
		return nil, false
	}
...
// SetRoles gets a reference to the given NullableRole and assigns it to the Roles field.
func (o *PolicyBindingPageResponse) SetRoles(v Role) {
	o.Roles.Set(&v)
}

// SetRolesNil sets the value for Roles to be an explicit nil
func (o *PolicyBindingPageResponse) SetRolesNil() {
	o.Roles.Set(nil)
}
...
func (o *PolicyBindingPageResponse) GetUsers() UserResponse {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PolicyBindingPageResponse) GetUsersOk() (*UserResponse, bool) {
	if o == nil {
		return nil, false
	}
...
// SetUsers gets a reference to the given NullableUserResponse and assigns it to the Users field.
func (o *PolicyBindingPageResponse) SetUsers(v UserResponse) {
	o.Users.Set(&v)
}

// SetUsersNil sets the value for Users to be an explicit nil
func (o *PolicyBindingPageResponse) SetUsersNil() {
	o.Users.Set(nil)
}
