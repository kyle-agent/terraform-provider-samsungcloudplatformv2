...
// checks if the GroupMemberCreateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupMemberCreateRequest{}
...
type _GroupMemberCreateRequest GroupMemberCreateRequest

// NewGroupMemberCreateRequest instantiates a new GroupMemberCreateRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGroupMemberCreateRequest(userId string) *GroupMemberCreateRequest {
	this := GroupMemberCreateRequest{}
	this.UserId = userId
	return &this
}

// NewGroupMemberCreateRequestWithDefaults instantiates a new GroupMemberCreateRequest object
...
func (o *GroupMemberCreateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupMemberCreateRequest := _GroupMemberCreateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGroupMemberCreateRequest)

	if err != nil {
		return err
	}

	*o = GroupMemberCreateRequest(varGroupMemberCreateRequest)

	return err
}

type NullableGroupMemberCreateRequest struct {
	value *GroupMemberCreateRequest
	isSet bool
}
...
func NewNullableGroupMemberCreateRequest(val *GroupMemberCreateRequest) *NullableGroupMemberCreateRequest {
	return &NullableGroupMemberCreateRequest{value: val, isSet: true}
}
