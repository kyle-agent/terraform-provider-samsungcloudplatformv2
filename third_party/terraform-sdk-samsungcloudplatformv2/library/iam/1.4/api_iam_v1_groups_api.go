...
func (r IamV1GroupsApiAPIListGroupRequest) HasMember(hasMember bool) IamV1GroupsApiAPIListGroupRequest {
	r.hasMember = &hasMember
	return r
}

// Group Role Existence
func (r IamV1GroupsApiAPIListGroupRequest) HasRole(hasRole bool) IamV1GroupsApiAPIListGroupRequest {
	r.hasRole = &hasRole
	return r
}

// Group Completion Status
func (r IamV1GroupsApiAPIListGroupRequest) IsCompleted(isCompleted bool) IamV1GroupsApiAPIListGroupRequest {
...
func (r IamV1GroupsApiAPIListGroupMemberRequest) Execute() (*GroupMemberPageResponseV1Dot4, *http.Response, error) {
...
// Execute executes the request
//
//	@return GroupMemberPageResponseV1Dot4
func (a *IamV1GroupsApiAPIService) ListGroupMemberExecute(r IamV1GroupsApiAPIListGroupMemberRequest) (*GroupMemberPageResponseV1Dot4, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GroupMemberPageResponseV1Dot4
	)
