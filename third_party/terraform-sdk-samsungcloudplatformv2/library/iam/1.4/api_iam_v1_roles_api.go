...
type IamV1RolesApiAPICreateRoleRequest struct {
	ctx                     context.Context
	ApiService              *IamV1RolesApiAPIService
	roleCreateRequestV1Dot3 *RoleCreateRequestV1Dot3
}

func (r IamV1RolesApiAPICreateRoleRequest) RoleCreateRequestV1Dot3(roleCreateRequestV1Dot3 RoleCreateRequestV1Dot3) IamV1RolesApiAPICreateRoleRequest {
	r.roleCreateRequestV1Dot3 = &roleCreateRequestV1Dot3
	return r
}
...
func (a *IamV1RolesApiAPIService) CreateRoleExecute(r IamV1RolesApiAPICreateRoleRequest) (*RoleShowResponse, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.roleCreateRequestV1Dot3 == nil {
		return localVarReturnValue, nil, reportError("roleCreateRequestV1Dot3 is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.roleCreateRequestV1Dot3
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["X-Auth-Token"]; ok {
...
// Policy Type List Attached to Role
...
Detach policy to Role
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param roleId Role ID
	@param policyId Policy ID Attached to Role
