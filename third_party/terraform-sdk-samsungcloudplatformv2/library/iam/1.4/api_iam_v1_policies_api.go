...
func (r IamV1PoliciesApiAPIListPolicyBindingRequest) Execute() (*PolicyBindingPageResponseV1Dot4, *http.Response, error) {
...
// Execute executes the request
//
//	@return PolicyBindingPageResponseV1Dot4
func (a *IamV1PoliciesApiAPIService) ListPolicyBindingExecute(r IamV1PoliciesApiAPIListPolicyBindingRequest) (*PolicyBindingPageResponseV1Dot4, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *PolicyBindingPageResponseV1Dot4
	)
