...
func (o *GroupCreateRequest) GetPolicyIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GroupCreateRequest) GetPolicyIdsOk() ([]string, bool) {
...
func (o *GroupCreateRequest) HasPolicyIds() bool {
	if o != nil && !IsNil(o.PolicyIds) {
		return true
	}
...
func (o *GroupCreateRequest) SetPolicyIds(v []string) {
	o.PolicyIds = v
}
