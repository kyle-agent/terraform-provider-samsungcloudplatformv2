...
// size
func (r VpcV1InternetGatewaysApiAPIListInternetGatewaysRequest) Size(size int32) VpcV1InternetGatewaysApiAPIListInternetGatewaysRequest {
	r.size = &size
	return r
}

// page
func (r VpcV1InternetGatewaysApiAPIListInternetGatewaysRequest) Page(page int32) VpcV1InternetGatewaysApiAPIListInternetGatewaysRequest {
	r.page = &page
	return r
}
...
func (r VpcV1InternetGatewaysApiAPIListInternetGatewaysRequest) Execute() (*InternetGatewayListResponseV1Dot2, *http.Response, error) {
...
// Execute executes the request
//  @return InternetGatewayListResponseV1Dot2
func (a *VpcV1InternetGatewaysApiAPIService) ListInternetGatewaysExecute(r VpcV1InternetGatewaysApiAPIListInternetGatewaysRequest) (*InternetGatewayListResponseV1Dot2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *InternetGatewayListResponseV1Dot2
	)
