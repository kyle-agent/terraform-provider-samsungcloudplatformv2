...
type VpcV1TransitGatewayRulesApiAPIListTransitGatewayRulesRequest struct {
	...
	ruleType *TransitGatewayRuleType
}
...
// Rule Type
func (r VpcV1TransitGatewayRulesApiAPIListTransitGatewayRulesRequest) RuleType(ruleType TransitGatewayRuleType) VpcV1TransitGatewayRulesApiAPIListTransitGatewayRulesRequest {
	r.ruleType = &ruleType
	return r
}

func (r VpcV1TransitGatewayRulesApiAPIListTransitGatewayRulesRequest) Execute() (*TransitGatewayRuleListResponseV1Dot2, *http.Response, error) {
...
// Execute executes the request
//  @return TransitGatewayRuleListResponseV1Dot2
func (a *VpcV1TransitGatewayRulesApiAPIService) ListTransitGatewayRulesExecute(r VpcV1TransitGatewayRulesApiAPIListTransitGatewayRulesRequest) (*TransitGatewayRuleListResponseV1Dot2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *TransitGatewayRuleListResponseV1Dot2
	)
