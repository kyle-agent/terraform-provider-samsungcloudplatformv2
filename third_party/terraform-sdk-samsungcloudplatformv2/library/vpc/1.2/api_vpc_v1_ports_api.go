...
func (r VpcV1PortsApiAPICreatePortRequest) Execute() (*PortShowResponseV1Dot2, *http.Response, error) {
...
//  @return PortShowResponseV1Dot2
func (a *VpcV1PortsApiAPIService) CreatePortExecute(r VpcV1PortsApiAPICreatePortRequest) (*PortShowResponseV1Dot2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PortShowResponseV1Dot2
	)
...
type VpcV1PortsApiAPIListPortsRequest struct {
	...
	attachedResourceTypes *AttachedResourceTypes
}
...
func (r VpcV1PortsApiAPIListPortsRequest) AttachedResourceTypes(attachedResourceTypes AttachedResourceTypes) VpcV1PortsApiAPIListPortsRequest {
	r.attachedResourceTypes = &attachedResourceTypes
	return r
}
...
func (a *VpcV1PortsApiAPIService) ListPortsExecute(r VpcV1PortsApiAPIListPortsRequest) (*PortListResponse, *http.Response, error) {
	...
	if r.attachedResourceTypes != nil {
        data := r.attachedResourceTypes
        data_val := *data
        val := reflect.ValueOf(data_val)
        for i := 0; i < val.NumField(); i++ {
            field := val.Field(i)
            if field.IsValid() && !field.IsZero() {
                parameterAddToHeaderOrQuery(localVarQueryParams, "attached_resource_types", field.Interface(), "form", "")
            }
        }
    }
	// to determine the Content-Type header
...
func (r VpcV1PortsApiAPISetPortRequest) Execute() (*PortShowResponseV1Dot2, *http.Response, error) {
...
// Execute executes the request
//  @return PortShowResponseV1Dot2
func (a *VpcV1PortsApiAPIService) SetPortExecute(r VpcV1PortsApiAPISetPortRequest) (*PortShowResponseV1Dot2, *http.Response, error) {
	var (
...
func (r VpcV1PortsApiAPIShowPortRequest) Execute() (*PortShowResponseV1Dot2, *http.Response, error) {
...
// Execute executes the request
//  @return PortShowResponseV1Dot2
func (a *VpcV1PortsApiAPIService) ShowPortExecute(r VpcV1PortsApiAPIShowPortRequest) (*PortShowResponseV1Dot2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
