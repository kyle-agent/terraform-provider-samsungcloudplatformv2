...
// size
func (r VpcV1NatGatewayApiAPIListNatGatewaysRequest) Size(size int32) VpcV1NatGatewayApiAPIListNatGatewaysRequest {
	r.size = &size
	return r
}

// page
func (r VpcV1NatGatewayApiAPIListNatGatewaysRequest) Page(page int32) VpcV1NatGatewayApiAPIListNatGatewaysRequest {
	r.page = &page
	return r
}
...
func (r VpcV1NatGatewayApiAPIListNatGatewaysRequest) Execute() (*NatGatewayListResponseV1Dot2, *http.Response, error) {
...
// Execute executes the request
//  @return NatGatewayListResponseV1Dot2
func (a *VpcV1NatGatewayApiAPIService) ListNatGatewaysExecute(r VpcV1NatGatewayApiAPIListNatGatewaysRequest) (*NatGatewayListResponseV1Dot2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *NatGatewayListResponseV1Dot2
	)
