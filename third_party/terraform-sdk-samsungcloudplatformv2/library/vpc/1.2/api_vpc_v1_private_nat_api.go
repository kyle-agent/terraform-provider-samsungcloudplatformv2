...
type VpcV1PrivateNatApiAPICreatePrivateNatRequest struct {
	...
	privateNatCreateRequestV1Dot2 *PrivateNatCreateRequestV1Dot2
}

func (r VpcV1PrivateNatApiAPICreatePrivateNatRequest) PrivateNatCreateRequestV1Dot2(privateNatCreateRequestV1Dot2 PrivateNatCreateRequestV1Dot2) VpcV1PrivateNatApiAPICreatePrivateNatRequest {
	r.privateNatCreateRequestV1Dot2 = &privateNatCreateRequestV1Dot2
	return r
}

func (r VpcV1PrivateNatApiAPICreatePrivateNatRequest) Execute() (*PrivateNatShowResponseV1Dot2, *http.Response, error) {
...
//  @return PrivateNatShowResponseV1Dot2
func (a *VpcV1PrivateNatApiAPIService) CreatePrivateNatExecute(r VpcV1PrivateNatApiAPICreatePrivateNatRequest) (*PrivateNatShowResponseV1Dot2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PrivateNatShowResponseV1Dot2
	)
	...
	if r.privateNatCreateRequestV1Dot2 == nil {
		return localVarReturnValue, nil, reportError("privateNatCreateRequestV1Dot2 is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.privateNatCreateRequestV1Dot2
	if r.ctx != nil {
...
type VpcV1PrivateNatApiAPIListPrivateNatsRequest struct {
	...
	serviceType *PrivateNatServiceType
...
func (r VpcV1PrivateNatApiAPIListPrivateNatsRequest) ServiceResourceId(serviceResourceId string) VpcV1PrivateNatApiAPIListPrivateNatsRequest {
	r.serviceResourceId = &serviceResourceId
	return r
}

// Private NAT connected Service Type
func (r VpcV1PrivateNatApiAPIListPrivateNatsRequest) ServiceType(serviceType PrivateNatServiceType) VpcV1PrivateNatApiAPIListPrivateNatsRequest {
	r.serviceType = &serviceType
	return r
}

// Private NAT connected Service Resource Name
func (r VpcV1PrivateNatApiAPIListPrivateNatsRequest) ServiceResourceName(serviceResourceName string) VpcV1PrivateNatApiAPIListPrivateNatsRequest {
	r.serviceResourceName = &serviceResourceName
	return r
}
...
func (r VpcV1PrivateNatApiAPIListPrivateNatsRequest) Execute() (*PrivateNatListResponseV1Dot2, *http.Response, error) {
...
// Execute executes the request
//  @return PrivateNatListResponseV1Dot2
func (a *VpcV1PrivateNatApiAPIService) ListPrivateNatsExecute(r VpcV1PrivateNatApiAPIListPrivateNatsRequest) (*PrivateNatListResponseV1Dot2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PrivateNatListResponseV1Dot2
	)
	...
	if r.serviceResourceId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "service_resource_id", r.serviceResourceId, "form", "")
    }
	if r.serviceType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "service_type", r.serviceType, "form", "")
    }
	if r.serviceResourceName != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "service_resource_name", r.serviceResourceName, "form", "")
    }
	if r.state != nil {
...
func (r VpcV1PrivateNatApiAPISetPrivateNatRequest) Execute() (*PrivateNatShowResponseV1Dot2, *http.Response, error) {
...
// Execute executes the request
//  @return PrivateNatShowResponseV1Dot2
func (a *VpcV1PrivateNatApiAPIService) SetPrivateNatExecute(r VpcV1PrivateNatApiAPISetPrivateNatRequest) (*PrivateNatShowResponseV1Dot2, *http.Response, error) {
	var (
...
func (r VpcV1PrivateNatApiAPIShowPrivateNatRequest) Execute() (*PrivateNatShowResponseV1Dot2, *http.Response, error) {
...
// Execute executes the request
//  @return PrivateNatShowResponseV1Dot2
func (a *VpcV1PrivateNatApiAPIService) ShowPrivateNatExecute(r VpcV1PrivateNatApiAPIShowPrivateNatRequest) (*PrivateNatShowResponseV1Dot2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
