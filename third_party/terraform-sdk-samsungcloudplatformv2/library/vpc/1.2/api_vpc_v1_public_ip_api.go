...
// size
func (r VpcV1PublicIpApiAPIListPublicipRequest) Size(size int32) VpcV1PublicIpApiAPIListPublicipRequest {
	r.size = &size
	return r
}

// page
func (r VpcV1PublicIpApiAPIListPublicipRequest) Page(page int32) VpcV1PublicIpApiAPIListPublicipRequest {
	r.page = &page
	return r
}
...
func (r VpcV1PublicIpApiAPIListPublicipRequest) Execute() (*PublicipListResponseV1Dot2, *http.Response, error) {
...
// Execute executes the request
//  @return PublicipListResponseV1Dot2
func (a *VpcV1PublicIpApiAPIService) ListPublicipExecute(r VpcV1PublicIpApiAPIListPublicipRequest) (*PublicipListResponseV1Dot2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PublicipListResponseV1Dot2
	)
