...
const (
	...
	PRIVATENATIPATTACHEDRESOURCETYPE_ALB PrivateNatIpAttachedResourceType = "ALB"
	PRIVATENATIPATTACHEDRESOURCETYPE_GPU_SERVER PrivateNatIpAttachedResourceType = "GPU_SERVER"
)
