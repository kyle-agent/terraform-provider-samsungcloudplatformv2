...
type EventstreamsV1EventStreamsClustersApiAPIEventstreamsCreateClusterRequest struct {
	ctx                                    context.Context
	ApiService                             *EventstreamsV1EventStreamsClustersApiAPIService
	eventStreamsClusterCreateRequestV1Dot1 *EventStreamsClusterCreateRequestV1Dot1
}

func (r EventstreamsV1EventStreamsClustersApiAPIEventstreamsCreateClusterRequest) EventStreamsClusterCreateRequestV1Dot1(eventStreamsClusterCreateRequestV1Dot1 EventStreamsClusterCreateRequestV1Dot1) EventstreamsV1EventStreamsClustersApiAPIEventstreamsCreateClusterRequest {
	r.eventStreamsClusterCreateRequestV1Dot1 = &eventStreamsClusterCreateRequestV1Dot1
	return r
}
...
func (a *EventstreamsV1EventStreamsClustersApiAPIService) EventstreamsCreateClusterExecute(r EventstreamsV1EventStreamsClustersApiAPIEventstreamsCreateClusterRequest) (*AsyncResponse, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.eventStreamsClusterCreateRequestV1Dot1 == nil {
		return localVarReturnValue, nil, reportError("eventStreamsClusterCreateRequestV1Dot1 is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.eventStreamsClusterCreateRequestV1Dot1
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["X-Auth-Token"]; ok {
...
func (r EventstreamsV1EventStreamsClustersApiAPIEventstreamsShowClusterRequest) Execute() (*EventStreamsClusterDetailResponseV1Dot1, *http.Response, error) {
...
// Execute executes the request
//  @return EventStreamsClusterDetailResponseV1Dot1
func (a *EventstreamsV1EventStreamsClustersApiAPIService) EventstreamsShowClusterExecute(r EventstreamsV1EventStreamsClustersApiAPIEventstreamsShowClusterRequest) (*EventStreamsClusterDetailResponseV1Dot1, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *EventStreamsClusterDetailResponseV1Dot1
	)
