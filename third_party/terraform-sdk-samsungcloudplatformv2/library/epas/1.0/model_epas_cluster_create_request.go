...
// checks if the EpasClusterCreateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EpasClusterCreateRequest{}

// EpasClusterCreateRequest struct for EpasClusterCreateRequest
type EpasClusterCreateRequest struct {
	...
	InitConfigOption EpasInitConfigOptionRequest `json:"init_config_option"`
...
type _EpasClusterCreateRequest EpasClusterCreateRequest
...
func (o *EpasClusterCreateRequest) GetInitConfigOption() EpasInitConfigOptionRequest {
	if o == nil {
		var ret EpasInitConfigOptionRequest
		return ret
	}
...
func (o *EpasClusterCreateRequest) SetMaintenanceOptionNil() {
...
func (o *EpasClusterCreateRequest) SetOriginClusterIdNil() {
...
func (o *EpasClusterCreateRequest) SetVipPublicIpIdNil() {
...
func (o *EpasClusterCreateRequest) SetVirtualIpAddressNil() {
...
func (o EpasClusterCreateRequest) MarshalJSON() ([]byte, error) {
...
func (o EpasClusterCreateRequest) ToMap() (map[string]interface{}, error) {
...
func (o *EpasClusterCreateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varEpasClusterCreateRequest := _EpasClusterCreateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEpasClusterCreateRequest)

	if err != nil {
		return err
	}

	*o = EpasClusterCreateRequest(varEpasClusterCreateRequest)

	return err
}

type NullableEpasClusterCreateRequest struct {
	value *EpasClusterCreateRequest
	isSet bool
}

func (v NullableEpasClusterCreateRequest) Get() *EpasClusterCreateRequest {
	return v.value
}

func (v *NullableEpasClusterCreateRequest) Set(val *EpasClusterCreateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableEpasClusterCreateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableEpasClusterCreateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEpasClusterCreateRequest(val *EpasClusterCreateRequest) *NullableEpasClusterCreateRequest {
	return &NullableEpasClusterCreateRequest{value: val, isSet: true}
}

func (v NullableEpasClusterCreateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEpasClusterCreateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
