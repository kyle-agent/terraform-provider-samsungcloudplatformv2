...
// checks if the SqlserverAddBlockStoragesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SqlserverAddBlockStoragesRequest{}
...
type _SqlserverAddBlockStoragesRequest SqlserverAddBlockStoragesRequest
...
func NewSqlserverAddBlockStoragesRequest(roleType BlockStorageGroupRoleType, sizeGb int32) *SqlserverAddBlockStoragesRequest {
	this := SqlserverAddBlockStoragesRequest{}
...
func (o *SqlserverAddBlockStoragesRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSqlserverAddBlockStoragesRequest := _SqlserverAddBlockStoragesRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSqlserverAddBlockStoragesRequest)

	if err != nil {
		return err
	}

	*o = SqlserverAddBlockStoragesRequest(varSqlserverAddBlockStoragesRequest)

	return err
}

type NullableSqlserverAddBlockStoragesRequest struct {
	value *SqlserverAddBlockStoragesRequest
	isSet bool
}
...
func NewNullableSqlserverAddBlockStoragesRequest(val *SqlserverAddBlockStoragesRequest) *NullableSqlserverAddBlockStoragesRequest {
	return &NullableSqlserverAddBlockStoragesRequest{value: val, isSet: true}
}
